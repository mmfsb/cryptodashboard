...
BTC = yf.download(Bitcoin, start='2022-01-07', end='2022-01-07')
ETH = yf.download(Ethereum, start='2022-01-07', end='2022-01-07')
XRP = yf.download(Ripple, start='2022-01-07', end='2022-01-07')
BCH = yf.download(BitcoinCash, start='2022-01-07', end='2022-01-07')
